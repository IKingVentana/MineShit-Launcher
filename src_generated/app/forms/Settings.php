...
$e = $event ?: $e; // legacy code from 16 rc-2
		...
		UXDialog::showAndWait('Изменение пути установки временно недоступно. Мы работаем над добавлением этой функции.', 'WARNING');
...
$e = $event ?: $e; // legacy code from 16 rc-2
		...
		UXDialog::showAndWait('Удалить лаунчер? Просто закройте его и удалите файл MineShit Launcher.exe вручную.');
