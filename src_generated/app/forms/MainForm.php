...
$e = $event ?: $e; // legacy code from 16 rc-2
		...
		UXDialog::showAndWait('Вы ещё не вошли в профиль. Доступ к настройкам модов возможен только после входа.', 'WARNING');
...
$e = $event ?: $e; // legacy code from 16 rc-2
		...
		UXDialog::showAndWait('Запуск невозможен: профиль не выбран. Пожалуйста, войдите в аккаунт, прежде чем запускать игру.', 'ERROR');
